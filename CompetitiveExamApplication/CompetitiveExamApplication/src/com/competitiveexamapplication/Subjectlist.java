...
public class Subjectlist extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        HttpPost httppost2 = new HttpPost("http://marksinstitute.heliohost.org/admin/subject.php");
   ...
   //     	  this.values[i] = json2.toString(VIEW_LIST);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
		...
		String b = a.toString();
    	 ...
    	 edit.putString("cat", "subject");
    	 edit.putString("ename", b.toString());
    	 edit.apply();
    	 Log.e("log_tag", "Loading Intent data SubjectList  2" );
...
//		Toast.makeText(getBaseContext(), "This is it...!!!" + b.toString(), Toast.LENGTH_LONG).show();
		...
		Log.e("log_tag", "Loading Intent data SubjectList  3" );
	}
